...
//echo '<h1>'.$bio.$ccoll.$mobile.'</h1>';
	if(move_uploaded_file($file_loc,$folder.$final_file))
	{
      ...
      $sql="INSERT INTO files (name,profilepic) VALUES ('$name','$final_file')";
		...
		if(!$q)
			...
			{$_SESSION['name']=$name;
        echo "<h1>Successfully added your profile</h1>";
...
<nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="home.php">Maps.</a>
        </div>
  ...
  <form class="form-signin" method="post" action="editprofile1.php" >
    <!-- enctype="multipart/form-data" -->
      ...
      <div class="fileUpload btn btn-danger ">
        <span><i class="glyphicon glyphicon-upload"></i>Upload a Document</span>
       ...
       <!-- <br> <br><input type="text" name="bio" id="inputName" class="form-control" placeholder="Add your BIO" required autofocus>
        ...
        <input type="text" name="cbranch" id="inputEmail" class="form-control" placeholder="Branch/Specialization" required autofocus>
